...
[CreateAssetMenu (menuName = "Items/Gems/Percentage Health Gem")]
public class Percentage_Health_Gem : Gem
{
    public override bool EnhanceItem(GemHandler gem, ItemHandler handler)
    {
        ...
        Enchantment_Maximum_Health ench = Enchantment.GetEnchantmentPercentageHp() as Enchantment_Maximum_Health;
        ench.Value = value;
    ...
    {
        return "This a Health Gem. Use this to enchant an item and give it a percentage bonus of Health, based on the rarity of this gem.";
    }
