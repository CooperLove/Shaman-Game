...
public class CompanionQuestHandler : QuestHandler, ISelectHandler, IDeselectHandler
{
    [SerializeField] private EvoTreeComponent evoTreeComponent = null;
    public EvoTreeComponent EvoTreeComponent { get => evoTreeComponent; set => evoTreeComponent = value; }
    ...
    public override void OnSelect(BaseEventData eventData)
    {
        ...
        CompanionDescriptionPanel.Instance.EvoComponent = evoTreeComponent;
